...
import com.example.client.activity.AuthUtils;
import com.example.client.activity.activity.LogInActivity;
import com.example.client.activity.activity.MainActivity;
import com.example.client.R;
import com.example.client.activity.api.login.LoginResult;
import com.example.client.activity.api.login.Loginner;
import com.example.client.activity.threadManager.NetworkThread;
import com.example.client.activity.api.Login;

import retrofit2.Call;
import retrofit2.Response;

import static com.example.client.activity.api.RetrofitFactory.retrofitClient;
