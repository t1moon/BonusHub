...
public class HostStartInfoManager implements HostManager {
    private HostInfoView hostInfoView;
    SharedPreferences sp;
    int host_id;
    Host host;

    public HostStartInfoManager(HostInfoView hostInfoView, Context context) {
...
//        host_id = getHost_id(context);
    ...
    public void save_info(String title, String description, String address, int open_hour, int open_minute, int close_hour, int close_minute) {

        Storage.setHost_id(host_id, context);
